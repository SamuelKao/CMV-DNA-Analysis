...
triplets <- cbind(
  sorted_locations[seq(1, num_triplets - 2, by = 3)], # First element of each triplet
  sorted_locations[seq(2, num_triplets - 1, by = 3)], # Second element of each triplet
  sorted_locations[seq(3, num_triplets, by = 3)]
) # Third element of each triplet
...
for (i in 1:num_simulations) {
  ...
  simulated_triplets <- cbind(
    sorted_simulated_locations[seq(1, num_sim_triplets - 2, by = 3)], # First element of each triplet
