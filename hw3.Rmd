...
h <- plot(data$location, rep(1, num_palindromes), pch = 16, col = "blue",
     main = "Real vs. Simulated Palindrome Locations",
     xlab = "Position along DNA sequence", ylab = "Number of time", ylim = c(0.5, num_simulations + 0.5))

# Add simulated data points
points(simulated_data[[1]], rep(2, num_palindromes), pch = 16, col = rgb(1, 0, 0, 0.5))
for (i in 2:num_simulations) {
  points(simulated_data[[i]], rep(i + 1, num_palindromes), pch = 16, col = rgb(1, 0, 0, 0.5))
}
